...
## Conexiones
- [[Software de Drones]] — la cadena de comunicación en el contexto del stack
...
- [[DDS]] — detalle de cómo funciona la capa DDS y el puente microXRCE-DDS hacia PX4
- [[Comunicación en ROS2]] — las primitivas (topics, services, actions, parameters) detrás de `px4_msgs`
